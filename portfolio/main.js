...
import {asm6502} from "./components/asm6502.js";
...
function render(state) {
    ...
    if (state.page == "blog" && state.subpage == "none") {
        ...
        document.getElementById("asm-multiplication").addEventListener("click", function(event) {
            event.preventDefault();
            state.page = "blog";
            state.subpage = "asm-multiplication";
            render(state);
        });
    }
